...
import net.bskogen.ajtt.item.custom.FuelItem;
import net.bskogen.ajtt.item.custom.MetalDetectorItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> METAL_DETECTOR = ITEMS.register("metal_detector",
            () -> new MetalDetectorItem(new Item.Properties().durability(384)));
